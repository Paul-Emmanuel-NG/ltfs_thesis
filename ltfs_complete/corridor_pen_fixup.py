...
SPECS = {
    "corridor_pen.passenger.rou.xml": ("passenger", "veh_passenger", "veh"),
    "corridor_pen.bus.rou.xml":       ("bus",       "bus_bus",       "bus"),
    "corridor_pen.truck.rou.xml":     ("truck",     "truck_truck",   "truck"),
}
